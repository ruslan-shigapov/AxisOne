...
struct SaveSubgoalButtonView: View {
    ...
    let subgoal: Subgoal?
    let selectedSubgoalType: SubgoalTypes
    let title: String
    let notes: String
    let isUrgent: Bool
    ...
    let selectedTimeOfDay: TimesOfDay
    let partCompletion: Double
    let selectedStartDate: Date
    let selectedHabitFrequency: Frequencies
